          ...
          <ActionModalActionRow
            ...
            buttons={[
              ...
              <button
                ...
                className="flex items-center gap-2 px-6 py-2.5 rounded-lg bg-[image:var(--gradient-primary)] text-white hover:brightness-110 font-medium transition-all cursor-pointer disabled:opacity-70 disabled:cursor-not-allowed text-sm shadow-lg shadow-primary/20 border-0"
